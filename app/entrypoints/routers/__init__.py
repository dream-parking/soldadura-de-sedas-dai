...
from app.entrypoints.routers.materials import router as materiales_router
from app.entrypoints.routers.biweekly_payroll import router as nomina_quincenal_router
from app.entrypoints.routers.technical_measures import router as medidas_tecnicas_router
