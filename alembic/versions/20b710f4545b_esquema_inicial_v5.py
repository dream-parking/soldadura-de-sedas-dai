...
Revision ID: 20b710f4545b
Revises: 
Create Date: 2026-06-30 21:48:05.191528
...
def upgrade() -> None:
    ...
    sa.Column('payroll_id', sa.String(length=36), nullable=False),
    sa.Column('worker_id', sa.String(length=36), nullable=False),
    sa.Column('project_id', sa.String(length=36), nullable=False),
    sa.Column('payroll_fortnight_period', sa.String(length=50), nullable=False),
